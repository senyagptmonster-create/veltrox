...
class AppTheme {
  static const Color cBg = Color(0xFF0A0A0E);
  static const Color cSurface = Color(0xFF14141C);
  static const Color cEdge = Color(0xFF1F1F2C);
  static const Color cAccent = Color(0xFFF59E0B);
  static const Color cAccent2 = Color(0xFFFCD34D);
  static const Color cInk = Color(0xFFFEF3C7);
